jQuery(function ($) {
    jQuery('.woobe_meta_delete').life('click', function () {
    ...
    jQuery('#woobe_meta_add_new_btn').click(function () {
    ...
    jQuery('#woobe_meta_get_btn').click(function () {
    ...
    jQuery('.woobe_meta_view_selector').life('change', function () {
...
function woobe_act_meta_popup_editor(_this) {
    ...
    jQuery('.woobe-modal-save10').click(function () {
    ...
    jQuery('.woobe-modal-close10').click(function () {
...
function __woobe_init_meta_popup_editor() {
    ...
    jQuery('.meta_popup_editor_insert_new').click(function () {
        var li_html = jQuery('#meta_popup_editor_li').html();
    ...
    jQuery('.meta_popup_editor_insert_new_o').click(function () {
    ...
    jQuery('.meta_popup_editor_add_sub_item, .meta_popup_editor_add_sub_item2').click(function () {
