jQuery(function ($) {
    ...
    jQuery('#bulkoperations_att_visibility_add').click(function () {
    ...
    jQuery('.bulkoperations_att_visibility_del').life('click', function () {
        jQuery(this).parents('li').remove();
        if (jQuery('#bulkoperations_att_visibility li').size() === 0) {
