...
jQuery(function ($) {
    ...
    jQuery('.woobe_tools_panel_fprofile_btn').click(function () {
    ...
    jQuery('.woobe-modal-close-fprofile').click(function () {
    ...
    jQuery('#woobe_load_fprofile_btn').click(function () {
    ...
    jQuery('#woobe_new_fprofile_btn').click(function () {
    ...
    jQuery('.woobe_delete_fprofile').click(function () {
    ...
    jQuery("#woobe_load_fprofile_save").click(function () {
        if (jQuery('#woobe_load_fprofile_save').prop("checked") != true) {
            jQuery.ajax({
                method: "POST",
                url: ajaxurl,
