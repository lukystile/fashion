...
(function ($) {
    ...
    jQuery(function () {
        ...
        jQuery('.woobe_drag_and_drope').life('click', function () {
            return false;
        });

        //***

        jQuery('#tabs_f .woobe_calendar_cell_clear').click(function () {
        ...
        jQuery('#show_all_columns').click(function () {
        ...
        jQuery('.woobe_select_image').life('click', function ()
        {
        ...
        jQuery(document).scroll(function (e) {
            ...
            if (offset < 0) {
                if (!jQuery('#woobe_tools_panel').hasClass('woobe-adv-panel-fixed')) {
                    ...
                    jQuery('#woobe_tools_panel').css('width', jQuery('#tabs-products').width() + 'px');
                }
            } else {
        ...
        jQuery('.shop_manager_visibility').click(function () {
            var key = jQuery(this).data('key');
            var val = 0;
...
function woobe_init_advanced_panel() {
    ...
    //full width button
    jQuery('.woobe_tools_panel_full_width_btn').click(function () {
    ...
    jQuery('.woobe_tools_panel_profile_btn').click(function () {
    ...
    jQuery('.woobe-modal-close8').click(function () {
    ...
    jQuery('.woobe_tools_panel_newprod_btn').click(function () {
    ...
    jQuery('.woobe_tools_panel_duplicate_btn').click(function () {
    ...
    jQuery('.woobe_product_check').life('click', function (e) {
    ...
    //***
    //check all products
    jQuery('.all_products_checker').click(function () {
    ...
    jQuery('.woobe_tools_panel_uncheck_all').click(function () {
    ...
    jQuery('.woobe_tools_panel_delete_btn').click(function () {
    ...
    setTimeout(function () {
        ...
        //jQuery('.woobe_top_panel').height(500);
    ...
    /*
     ...
     jQuery('.woobe_top_panel').hide();
     jQuery('.woobe_top_panel').height(500);
     jQuery('.woobe_top_panel').css('margin-top', 0);
     };
     */

    //Show/Hide button for filter
    jQuery('.woobe_top_panel_btn').click(function () {
        var _this = this;
        jQuery('.woobe_top_panel').slideToggle('slow', function () {
            if (jQuery(this).is(':visible')) {
                jQuery(_this).html(lang.close_panel);
                //jQuery('#woobe_scroll_left').hide();
                //jQuery('#woobe_scroll_right').hide();
            } else {
                /*
                 if (jQuery('#advanced-table').width() > jQuery('#tabs-products').width()) {
    ...
    jQuery('.woobe_top_panel_btn2').click(function (e) {
...
function woobe_init_profiles() {
    ...
    jQuery('#woobe_load_profile_btn').click(function () {
    ...
    jQuery('#woobe_new_profile_btn').click(function () {
    ...
    jQuery('.woobe_delete_profile').click(function () {
...
function __trigger_resize() {
    ...
    /*
     * for tests
     jQuery('.woobe_tools_panel_full_width_btn').trigger('click', function () {
     jQuery('.woobe_tools_panel_full_width_btn').trigger('click');
     });
     */
